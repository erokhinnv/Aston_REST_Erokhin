...
class RepositoryUtils {
    ...
    // сделать функцию, которая будет создавать все таблицы и вызывать её из конструкторов всех репозиториев

    static void createTablesIfNotExist(Connection connection) throws SQLException {
